...
import config, memcache, random, string, time, os, sys, subprocess
...
def led(v):
    subprocess.Popen(['python3', '/root/piFlightBox/led.py', str(v)], stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
